...
lint-py:  ## lint python with ruff
	python -m ruff check nbprint_mlflow
	python -m ruff format --check nbprint_mlflow
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix nbprint_mlflow
	python -m ruff format nbprint_mlflow
...
test:  ## run python tests
	python -m pytest -v nbprint_mlflow/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v nbprint_mlflow/tests --cov=nbprint_mlflow --cov-report term-missing --cov-report xml
